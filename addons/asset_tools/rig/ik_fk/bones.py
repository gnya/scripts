...
def _check_ik_fk_bone(bone: PoseBone) -> tuple[bool, str, str, str]:
...
def check_ik_fk_bones(bones: list[PoseBone]) -> set[tuple[Object, str, str, str]]:
    groups = set()
...
def _ik_fk_arm_bone_names(lr: str):
    return {
...
def _ik_fk_leg_bone_names(lr: str):
    return {
...
def ik_fk_bones(
    armature: Object, group: str, lr: str
) -> tuple[dict[str, PoseBone], dict[str, str]]:
    bone_names = {}
    ...
    ik_fk_bones: dict[str, PoseBone] = {}
    missing_bones: dict[str, str] = {}
