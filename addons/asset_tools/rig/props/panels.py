...
def _layers_icon(value: bool):
    return "RADIOBUT_ON" if value else "RADIOBUT_OFF"


def _visibility_icon(value: bool):
...
# PTB
UI_CONTENTS["PTB"] = {"Body": {"data.layers[0]": ("Body", _layers_icon, 0, 1.0)}}
...
_HUMAN_UI_CONTENTS = {
    ...
    "Properties": {"data.layers[23]": ("Properties", _layers_icon, 0, 1.0)},
}
