...
class VIEW3D_OT_rig_copy_pose(bpy.types.Operator):
    ...
    def execute(self, context: Context) -> set[OperatorReturnItems]:
        ...
        for b in bones:
            ...
            m = obj.convert_space(
                pose_bone=b, matrix=b.matrix, from_space="POSE", to_space="WORLD"
            )

            data[b.name] = {"space": "WORLD", "matrix": [list(r) for r in m.row]}
        ...
        for depth in sorted_depth:
            for bone in depth_bone[depth]:
                ...
                b.matrix = obj.convert_space(
                    pose_bone=b,
                    matrix=Matrix(data[bone]["matrix"]),
                    from_space=data[bone]["space"],
                    to_space="POSE",
                )
        ...
        if context.tool_settings.use_keyframe_insert_auto:
            ...
            for bone in data.keys():
                ...
                if b.rotation_mode != "QUATERNION":
                    ...
                    b.keyframe_insert(
                        "rotation_quaternion", group=b.name, options=options
                    )
